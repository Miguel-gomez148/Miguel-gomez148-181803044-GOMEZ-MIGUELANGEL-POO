        ...
        <table>
            ...
            <table  class="table table-hover">
                ...
                <tr>
                    ...
                    <td scope="row"><%= rs.getInt("Edad")%></td>
                    ...
                    <td><a  class="btn btn-warning btn-block" href="formularioPassword.jsp?pass=<%= rs.getString("password")%>&id=<%= rs.getInt("id_usuario")%>">Editar Password</a></td>
                    <td><a  class="btn btn-danger btn-block" href="formularioEliminar.jsp?id=<%= rs.getInt("id_usuario")%>&usuario=<%= rs.getString("usuario")%>">Eliminar Usuario</a></td>
                </tr>
                <%}%>
            </table>
    </div>  <br><br>
