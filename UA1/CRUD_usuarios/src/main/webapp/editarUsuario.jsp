<%-- 
    ...
    Created on : 17/06/2020, 06:48:56 PM
    Author     : Pc
--%>
...
<%
    ...
    try {
        ...
        stmt = conexion.prepareStatement("UPDATE usuarios SET usuario=?, Edad=? WHERE id_usuario="+request.getParameter("userId"));
        ...
        switch (stmt.executeUpdate()) {
            ...
            <%break;
            case 1:%>
                <h1 style="background-color:lightblue;">Se ha editado correctamente al usuario</h1>
            <%break;
        }
%>
<html>
